...
# Bot Configuration
TOKEN = "8283776166:AAFpDWrUER9lz4-DERwnehPjhSEr-aMUPUY" #Cambiar por tu token
OWNER_ID = 8110076965 #ID TELEGRAM
...
⌥ <code>Check a single credit card</code>
...
async def handle_document(update: Update, context: CallbackContext):
    ...
    try:
        await update.message.reply_text("All CCs are being verified... bot by @rylax_network")
